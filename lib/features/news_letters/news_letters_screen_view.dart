...
import 'package:nextbestie_admin/features/news_letters/news_letters_screen_controller.dart';

class NewsLettersScreenView extends GetView {
  const NewsLettersScreenView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: NewsLettersScreenController(Get.find<INavigator>()),
        builder: (controller) {
          return Column(
            children: [
              20.verticalSpace,
              ...
              20.verticalSpace,
              Expanded(
                child: _buildNewsLettersTable(context, controller),
              ),
              50.verticalSpace,
            ],
          );
  ...
  Widget _buildHeader(
      BuildContext context, NewsLettersScreenController controller) {
    return Row(
      children: [
        15.horizontalSpace,
        Text(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (index == controller.newsLetters.length) {
                ...
                final newsLetter = controller.newsLetters[index];
                return Column(
                  children: [
                    _buildArticleRow(
                      context,
